    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://aimagelab.ing.unimore.it/imagelab/person.asp?idpersona=1">
                <h2>Rita Cucchiara</a>
            <p class="affiliation">(Università degli Studi di Modena e Reggio Emilia)</p></h2>
    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://people.epfl.ch/devis.tuia">
                <h2>Devis Tuia</a>
            <p class="affiliation">(École Polytechnique Fédérale de Lausanne)</p></h2>
        ...
        <div class="speaker">
            ...
            <div class="speaker-info">
                <a href="https://gael-varoquaux.info/">
                    <h2>Gaël Varoquaux</a>
                <p class="affiliation">(Inria Saclay)</p></h2>
                <p><strong>Title of the keynote: TBA.</strong></p>
                <p>Abstract: TBA.</p>
            </div>
        </div>
    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://davidrolnick.com/">
                <h2>David Rolnick</a>
            <p class="affiliation">(McGill University and Mila – Quebec AI Institute)</p></h2>
            <p><strong>Title of the keynote: TBA.</strong></p>
            <p>Abstract: TBA.</p>
        </div>
    </div>
        <div class="speaker">
            ...
            <div class="speaker-info">
                <a href="https://theallyance.one/team">
                    <h2>Caroline Therwath-Chavier</a>
                <p class="affiliation">(The Allyance)</p></h2>
