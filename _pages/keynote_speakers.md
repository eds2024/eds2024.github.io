    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://aimagelab.ing.unimore.it/imagelab/person.asp?idpersona=1">
                <h2>Rita Cucchiara</a></h2>
            <p class="affiliation">(Università degli Studi di Modena e Reggio Emilia)</p>
    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://people.epfl.ch/devis.tuia">
                <h2>Devis Tuia</a></h2>
            <p class="affiliation">(École Polytechnique Fédérale de Lausanne)</p>
        ...
        <div class="speaker">
            ...
            <div class="speaker-info">
                <a href="https://gael-varoquaux.info/">
                    <h2>Gaël Varoquaux</a></h2>
                <p class="affiliation">(Inria Saclay)</p>
                <p><strong>Title of the keynote: TBA.</strong></p>
                <p>Abstract: TBA.</p>
            </div>
        </div>
    ...
    <div class="speaker">
        ...
        <div class="speaker-info">
            <a href="https://davidrolnick.com/">
                <h2>David Rolnick</a></h2>
            <p class="affiliation">(McGill University and Mila – Quebec AI Institute)</p>
            <p><strong>Title of the keynote: TBA.</strong></p>
            <p>Abstract: TBA.</p>
        </div>
    </div>
        <div class="speaker">
            ...
            <div class="speaker-info">
                <a href="https://theallyance.one/team">
                    <h2>Caroline Therwath-Chavier</a></h2>
                <p class="affiliation">(The Allyance)</p>
